    ...
    public partial class Guncelle : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    baglanti.Open();
                    string query = "update UyeTbl set UAdSoyad='" + AdSoyadTb.Text + "',UTelefon='" + TelefonTb.Text + "',UCinsiyet='" + CinsiyetCb.SelectedItem.ToString() + "',UYas='" + YasTb.Text + "',UOdeme='" + OdemeTb.Text + "',UZamanlama='" + ZamanlamaCb.Text + "'where UId=" + key + ";";
                    SqlCommand komut = new SqlCommand(query, baglanti);
                    komut.ExecuteNonQuery();
